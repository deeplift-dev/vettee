...
export default function HomePage() {
  return (
    <div className="flex h-full flex-col justify-center overflow-auto py-24">
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <div className="flex flex-col items-center justify-center">
          ...
          <motion.p
            className="text-pretty mx-auto mt-2 max-w-lg text-center text-4xl font-medium tracking-tight text-gray-950 sm:text-5xl"
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
              <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                ...
                <p className="mt-2 max-w-lg text-base/6 text-gray-600 max-lg:text-center">
                  Get instant, personalised care and advice for your pets. Peace
                  of mind for you, and happiness for your pets.
                </p>
              </div>
          ...
          >
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                ...
                <p className="mt-2 max-w-lg text-base/6 text-gray-600 max-lg:text-center">
                  Vettee is currently in development. Add your email to know
                  when we've launched.
                </p>
              </div>
              <div className="flex flex-1 items-center justify-center px-8 max-lg:pb-12 max-lg:pt-10 sm:px-10 lg:pb-2">
                <form className="w-full max-w-sm">
                  <div className="flex items-center rounded-md border border-gray-200 px-2 py-2 shadow-sm">
                    <input
                    ...
                    />
                    <button
                      className="flex-shrink-0 rounded bg-gray-900 px-2 py-1 text-sm text-white hover:bg-gray-800"
                      type="button"
                    >
                      Sign Up
                    </button>
          ...
          >
            ...
            <div className="relative flex h-96 flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:h-full">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                <p className="mt-2 text-lg/7 font-medium tracking-tight text-gray-950 max-lg:text-center">
                  An app for all your animals
                </p>
                <p className="mt-2 max-w-lg text-base/6 text-gray-600 max-lg:text-center">
                  Whether you have a cat, dog, bird, or any other pet, Vettee is
                  here to help you take care of them.
                </p>
              </div>
