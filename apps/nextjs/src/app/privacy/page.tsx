    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        <article className="prose lg:prose-xl max-w-3xl mx-auto pb-24">
          ...
          <h3>b. Usage Data</h3>
          <p>
            When you access or use the App, we may automatically collect certain data, including but not limited to:
          </p>
          <ul>
            <li>Device Information (e.g., IP address, operating system, browser type)</li>
            <li>Usage Information (e.g., pages visited, time spent on each page)</li>
          ...
          <ul>
            ...
            <li>To provide personalized user experiences and recommendations.</li>
            <li>To respond to your comments, questions, or customer support requests.</li>
          ...
          <ul>
            <li>Service Providers: We may share your information with trusted service providers who assist in delivering services to you (e.g., analytics, cloud storage).</li>
          ...
          <p>
            Email: drjesseharvey@gmail.com<br />
            Address: info@vette.vet
          </p>
          <p>
            By using the Vetttee App, you acknowledge that you have read and understood this Privacy Policy and agree to its terms.
          </p>
        </article>
      </main>
    </div>
