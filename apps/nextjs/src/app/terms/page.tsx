      ...
      <main className="flex-1 px-2 lg:px-0">
        <section className="w-full py-12">
          ...
          <div className="mx-auto max-w-[600px] text-center text-gray-500">
            This covers the terms of use of the Vettee app. If you have any
            questions, please contact us at info@vettee.vet.
          </div>
        ...
        <article className="prose lg:prose-xl mx-auto max-w-3xl pb-24">
          <p>
            ...
            using the Vettee mobile application (the "Service") operated by
          ...
          <p>
            Vettee is an AI-powered application designed to assist pet owners in
            caring for their pets. The app provides [brief description of key
            features, e.g., "personalized feeding schedules, exercise
            recommendations, and health monitoring"].
          </p>
          ...
          <h3>5.1. Accuracy</h3>
          <p>
            The Service utilizes artificial intelligence to generate content and
            recommendations. While we strive for accuracy, we do not guarantee
            the completeness, reliability, or accuracy of this AI-generated
            content.
          </p>
          <h3>5.2. Professional Advice</h3>
          <p>
            AI-generated recommendations should not replace professional
            veterinary advice. Always consult with a qualified veterinarian for
          ...
          <p>
            ...
            property of [Your Company Name] and its licensors.
          </p>
